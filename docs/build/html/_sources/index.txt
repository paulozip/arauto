...
**Alchemy is an open-source and interactive tool for quick prototyping and experimentation of time series models**. You can use it to **build mixed autoregressive moving average models** (AR, MA, ARMA, ARIMA, SARIMA, ARIMAX, SARIMAX).
...
* Code generation: at the end of the process, Alchemy returns the code used to perform each step.
